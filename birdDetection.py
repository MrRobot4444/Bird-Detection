...
# pre-trained bird Haar Cascade classifier XML files: https://github.com/Souravjyoti/Bird_detection
bird1_cascade = cv2.CascadeClassifier('bird1-cascade.xml')
bird2_cascade = cv2.CascadeClassifier('bird2-cascade.xml')
 
cap = cv2.VideoCapture('Bird1.mp4')
...
while True: 
    ...
    cv2.putText(img, "Birds: " + str(len(birds1)), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
